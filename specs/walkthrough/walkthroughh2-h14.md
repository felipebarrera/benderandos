# Walkthrough: Hitos H2 - H14 Completados 🚀
...
## 5. Recursos Humanos & Reclutamiento (H13 - H14)
### H13: RRHH Completo (Chile)
- **Logro**: Gestión de personal con leyes sociales chilenas.
- **Backend**: `RrhhService` con lógica de descuentos legales (AFP, Salud) y `RrhhController`.
- **UI Admin**: Panel integrado en `admin_dashboard_v2.html` con marcación de asistencia.

### H14: Reclutamiento & Postulación
- **Logro**: Portal público de empleos y gestión ATS administrativa.
- **Backend**: `ReclutamientoService` con pipeline de selección y conversión a empleado.
- **UI Pública**: Página `empleos.html` funcional para postulantes externos.
- **Automatización**: Al marcar como "contratado", el postulante se convierte automáticamente en empleado.
